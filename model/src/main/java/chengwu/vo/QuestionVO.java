...
import chengwu.model.model.dto.question.JudgeConfig;
...
public class QuestionVO implements Serializable {
    ...
    public static QuestionVO objToVo(Question question) {
        ...
        List<String> judgeCases = JSONUtil.toList(question.getJudgeCase(), String.class);
        List<JudgeCase> list = new ArrayList<>();

        for (String judgeCaseStr : judgeCases) {
